<template>
  <footer class="bg-gray-900 dark:bg-black text-white" :class="marginClass">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-2">
          <NuxtLink to="/" class="flex items-center space-x-3 mb-4 group">
            ...
            <h3
              class="text-xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:to-indigo-300 transition-all duration-300"
            >
              AutoPlan
            </h3>
          </NuxtLink>
          ...
          <div class="flex space-x-4">
            <a
              href="mailto:support@autoplan.app"
              class="text-gray-400 hover:text-white transition-colors duration-300 p-2 rounded-lg hover:bg-gray-800"
              title="Email us"
            >
      ...
      <div class="border-t border-gray-800 mt-12 pt-8">
        ...
        >
          <p class="text-gray-400 text-sm">
            © {{ currentYear }} AutoPlan. All rights reserved.
          </p>
...
const marginClass = computed(() => {
  return props.addMarginTop ? "mt-16" : "";
});
</script>
